// From https://github.com/brewpuppy/bjcp-style-data
beers = {
  "beers": [
    {
      "name": "Light Lager",
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Very refreshing and thirst quenching.",
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Refreshing and thirst quenching, although generally more filling than standard/lite versions.",
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Malty but fully attenuated Pils malt showcase.",
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Balance and smoothness are the hallmarks of this style. It has the malt profile of a Helles, the hop character of a Pils, and is slightly stronger than both.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Ayinger Jahrhundert"
            },
            {
              "name": "Great Lakes Dortmunder Gold"
            },
            {
              "name": "Barrel House Duveneck's Dortmunder"
            },
            {
              "name": "Bell's Lager"
            },
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Crisp, clean, refreshing beer that prominently features noble German hop bitterness accentuated by sulfates in the water.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Old Dominion Tupper’s Hop Pocket Pils"
            },
            {
              "name": "König Pilsener"
            },
            ...
            {
              "name": "Left Hand Polestar Pilsner"
            },
            {
              "name": "Holsten Pils"
            },
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Crisp, complex and well-rounded yet refreshing.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Krušovice Imperial 12°"
            },
            {
              "name": "Budweiser Budvar",
              "note": "Czechvar in the US"
            },
            {
              "name": "Czech Rebel"
            },
            ...
            {
              "name": "Gambrinus Pilsner"
            },
            {
              "name": "Zlaty Bazant Golden Pheasant"
            },
            {
              "name": "Dock Street Bohemian Pilsner"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A substantial Pilsner that can stand up to the classic European Pilsners, but exhibiting the native American grains and hops available to German brewers who initially brewed it in the USA. Refreshing, but with the underlying malt and hops that stand out when compared to other modern American light lagers. Maize lends a distinctive grainy sweetness. Rice contributes a crisper, more neutral character.",
          ...
          "commercialExamples": [
            {
              "note": "Occasional brewpub and microbrewery specials"
            }
          ]
        }
      ]
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Characterized by soft, elegant maltiness that dries out in the finish to avoid becoming sweet.",
          ...
          "commercialExamples": [
            {
              ...
              "note": "Unusual in its 6.2% strength and 35 IBUs"
            },
            {
              "name": "Boulevard Bobs 47 Munich-Style Lager"
            },
            {
              "name": "Negra Modelo"
            },
            {
              "name": "Old Dominion Aviator Amber Lager"
            },
            {
              "name": "Gordon Biersch Vienna Lager"
            },
            {
              "name": "Capital Wisconsin Amber"
            },
            {
              "name": "Olde Saratoga Lager"
            },
            {
              "name": "Penn Pilsner"
            }
        ...
        },
        {
          ...
          "commercialExamples": [
            ...
            {
              "name": "Capital Oktoberfest"
            },
            {
              "name": "Gordon Biersch Märzen"
            },
            {
            ...
            },
            {
              ...
              "note": "A bit unusual in its late hopping"
            }
          ]
        }
      ]
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A somewhat sweeter version of standard/premium lager with a little more body and flavor.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Crystal Diplomat Dark Beer"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Characterized by depth and complexity of Munich malt and the accompanying melanoidins. Rich Munich flavors, but not as intense as a bock or as roasted as a schwarzbier.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Hacker-Pschorr Alt Munich Dark"
            },
            {
              "name": "Paulaner Alt Münchner Dunkel"
            },
            {
            ...
            {
              "name": "Harpoon Munich-type Dark Beer"
            },
            {
              "name": "Gordon Biersch Dunkels"
            },
            {
              "name": "Dinkel Acker Dark."
            },
            {
              "name": "Ettaler Dunkel",
              "note": "In Bavaria"
            ...
            {
              "name": "Löwenbräu Dunkel",
              "note": "In Bavaria"
            },
            {
              "name": "Hartmann Dunkel",
              "note": "In Bavaria"
            },
            {
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A dark German lager that balances roasted yet smooth malt flavors with moderate hop bitterness.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Kulmbacher Mönchshof Premium Schwarzbier"
            },
            {
              "name": "Samuel Adams Black Lager"
            },
            {
              "name": "Krušovice Cerne"
            },
            {
              "name": "Original Badebier"
            },
            {
            ...
            {
              "name": "Weeping Radish Black Radish Dark Lager"
            },
            {
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A relatively pale, strong, malty lager beer. Designed to walk a fine line between blandness and too much color. Hop character is generally more apparent than in other bocks.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Victory St. Boisterous"
            },
            {
              "name": "Gordon Biersch Blonde Bock"
            },
            {
              "name": "Smuttynose Maibock"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A dark, strong, malty lager beer.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Pennsylvania Brewing St. Nick Bock"
            },
            {
              "name": "Aass Bock"
            },
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A very strong and rich lager. A bigger version of either a traditional bock or a helles bock.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Eggenberg Urbock 23º"
            },
            {
              "name": "Bell’s Consecrator"
            },
            {
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "An extremely strong, full and malty dark lager.",
          ...
          "commercialExamples": [
            {
              "name": "Kulmbacher Reichelbräu Eisbock"
            },
            {
              "name": "Eggenberg Urbock Dunkel Eisbock"
            },
            {
              "name": "Niagara Eisbock"
            },
            {
              "name": "Capital Eisphyre"
            },
            {
              "name": "Southampton Eisbock"
            }
          ]
        }
      ]
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A clean, well-attenuated, flavorful American lawnmower beer.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Little Kings Cream Ale (Hudepohl)"
            },
            {
            ...
            {
              "name": "Wisconsin Brewing Whitetail Cream Ale"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Easy-drinking, approachable, malt-oriented American craft beer.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Rogue Oregon Golden Ale"
            },
            {
              "name": "Widmer Blonde Ale"
            },
            {
              "name": "Fuller’s Summer Ale"
            },
            {
              "name": "Hollywood Blonde"
            },
            {
              "name": "Redhook Blonde"
            }
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A clean, crisp, delicately balanced beer usually with very subtle fruit flavors and aromas. Subdued maltiness throughout leads to a pleasantly refreshing tang in the finish. To the untrained taster easily mistaken for a light lager, a somewhat subtle Pilsner, or perhaps a blonde ale.",
          ...
          "commercialExamples": [
            {
              "name": "PJ Früh",
              "note": "Available in Cologne only"
            },
            {
              "name": "Hellers",
              "note": "Available in Cologne only"
            ...
            {
              "name": "Reissdorf",
              "note": "Import version available in parts of North America"
            },
            {
              "name": "Gaffel",
              "note": "Import version available in parts of North America"
            ...
            {
              "name": "New Holland Lucid",
              "note": "Non-German Version"
            },
            {
              "name": "Saint Arnold Fancy Lawnmower",
              "note": "Non-German Version"
            },
            {
              "name": "Capitol City Capitol Kölsch",
              "note": "Non-German Version"
            },
            {
              "name": "Shiner Kölsch",
        ...
        },
        {
          ...
          "commercialExamples": [
            ...
            {
              "name": "Harpoon UFO Hefeweizen"
            },
            {
              "name": "Three Floyds Gumballhead"
            },
            {
              "name": "Pyramid Hefe-Weizen"
            },
            {
              "name": "Widmer Hefeweizen"
            },
            {
              "name": "Sierra Nevada Unfiltered Wheat Beer"
            },
            {
            ...
            {
              "name": "Real Ale Full Moon Pale Rye"
            }
          ]
        }
      ]
      ...
      "subcategories": [
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A very clean and relatively bitter beer, balanced by some malt character. Generally darker, sometimes more caramelly, and usually sweeter and less bitter than Düsseldorf Altbier.",
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A well balanced, bitter yet malty, clean, smooth, well-attenuated amber-colored German ale.",
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Low gravity, low alcohol levels and low carbonation make this an easy-drinking beer. Some examples can be more malt balanced, but this should not override the overall bitter impression. Drinkability is a critical component of the style; emphasis is still on the bittering hop addition as opposed to the aggressive middle and late hopping seen in American ales.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Oakham Jeffrey Hudson Bitter (JHB)"
            },
            {
              "name": "Brains Bitter"
            },
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A flavorful, yet refreshing, session beer. Some examples can be more malt balanced, but this should not override the overall bitter impression. Drinkability is a critical component of the style; emphasis is still on the bittering hop addition as opposed to the aggressive middle and late hopping seen in American ales.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Shepherd Neame Masterbrew Bitter"
            },
            {
              "name": "Greene King Ruddles County Bitter"
            },
            {
              "name": "RCH Pitchfork Rebellious Bitter"
            },
            {
              "name": "Brains SA"
            },
            ...
            {
              "name": "Rogue Younger’s Special Bitter"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "An average-strength to moderately-strong English ale. The balance may be fairly even between malt and hops to somewhat bitter. Drinkability is a critical component of the style; emphasis is still on the bittering hop addition as opposed to the aggressive middle and late hopping seen in American ales. A rather broad style that allows for considerable interpretation by the brewer.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Gale’s Hordean Special Bitter (HSB)"
            },
            {
              "name": "Ushers 1824 Particular Ale"
            },
            {
              "name": "Hopback Summer Lightning"
            },
            {
              "name": "Great Lakes Moondog Ale"
            },
            {
              "name": "Shipyard Old Thumper"
            },
            {
              "name": "Alaskan ESB"
            },
            ...
            {
              "name": "Cooperstown Old Slugger"
            },
            {
              "name": "Anderson Valley Boont ESB"
            },
            {
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Cleanly malty with a drying finish, perhaps a few esters, and on occasion a faint bit of peaty earthiness (smoke). Most beers finish fairly dry considering their relatively sweet palate, and as such have a different balance than strong Scotch ales.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Maclay 60/- Light",
              "note": "All are cask-only products not exported to the US"
            }
          ]
        },
        {
          ...
          "commercialExamples": [
            {
              "name": "Caledonian 70/-",
              "note": "Caledonian Amber Ale in the US"
            },
            {
              "name": "Belhaven 70/-"
            },
        ...
        },
        {
          ...
          "commercialExamples": [
            ...
            {
              "name": "Caledonian 80/- Export Ale"
            },
            {
              "name": "Belhaven 80/-",
              "note": "Belhaven Scottish Ale in the US"
            },
            {
              "name": "Southampton 80 Shilling"
            },
            {
              "name": "Broughton Exciseman’s 80/-"
            },
            {
              "name": "Belhaven St. Andrews Ale, McEwan's Export (IPA)"
            },
            {
              "name": "Inveralmond Lia Fail"
            },
            {
              "name": "Broughton Merlin’s Ale"
            },
            {
              "name": "Arran Dark"
            }
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "An easy-drinking pint. Malt-focused with an initial sweetness and a roasted dryness in the finish.",
          ...
          "commercialExamples": [
            {
              "name": "Three Floyds Brian Boru Old Irish Ale"
            },
            {
              "name": "Great Lakes Conway’s Irish Ale",
              "note": "A bit strong at 6.5%"
            },
            {
            ...
            {
              "name": "Boulevard Irish Ale"
            },
            {
              "name": "Harpoon Hibernian Ale"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Rich, malty and usually sweet, which can be suggestive of a dessert. Complex secondary malt flavors prevent a one-dimensional impression. Strength and maltiness can vary.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Inveralmond Black Friar"
            },
            {
              "name": "Broughton Old Jock"
            },
            {
              "name": "Gordon Highland Scotch Ale"
            },
            {
              "name": "Dragonmead Under the Kilt"
            }
          ]
        }
      ]
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Refreshing and hoppy, yet with sufficient supporting malt.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Great Lakes Burning River Pale Ale"
            },
            {
              "name": "Bear Republic XP Pale Ale"
            },
            {
              "name": "Anderson Valley Poleeko Gold Pale Ale"
            },
            {
              "name": "Deschutes Mirror Pond"
            },
            {
              "name": "Full Sail Pale Ale"
            },
            {
              "name": "Three Floyds X-Tra Pale Ale"
            },
            {
              "name": "Firestone Pale Ale"
            },
            {
              "name": "Left Hand Brewing Jackman’s Pale Ale"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Like an American pale ale with more body, more caramel richness, and a balance more towards malt than hops (although hop rates can be significant).",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Pyramid Broken Rake"
            },
            {
              "name": "St. Rogue Red Ale"
            },
            {
              "name": "Anderson Valley Boont Amber Ale"
            },
            {
              "name": "Lagunitas Censored Ale"
            },
            {
              "name": "Avery Redpoint Ale"
            },
            {
              "name": "McNeill’s Firehouse Amber Ale"
            },
            {
              "name": "Mendocino Red Tail Ale"
            },
            {
              "name": "Bell's Amber"
            }
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Can be considered a bigger, maltier, hoppier interpretation of Northern English brown ale or a hoppier, less malty Brown Porter, often including the citrus-accented hop presence that is characteristic of American hop varieties.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "North Coast Acme Brown"
            },
            {
              "name": "Brooklyn Brown Ale"
            },
            {
              "name": "Lost Coast Downtown Brown"
            },
            {
              "name": "Left Hand Deep Cover Brown Ale"
            }
          ]
        }
      ]
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A light-flavored, malt-accented beer that is readily suited to drinking in quantity. Refreshing, yet flavorful. Some versions may seem like lower gravity brown porters.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Coach House Gunpowder Strong Mild"
            },
            {
              "name": "Woodforde’s Mardler’s Mild"
            },
            {
              "name": "Greene King XX Mild"
            },
            {
              "name": "Motor City Brewing Ghettoblaster"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A luscious, malt-oriented brown ale, with a caramel, dark fruit complexity of malt flavor. May seem somewhat like a smaller version of a sweet stout or a sweet version of a dark mild.",
          ...
          "commercialExamples": [
            {
              ...
              "note": "Bottled but not available in the US"
            },
            {
              "name": "Harvey’s Nut Brown Ale"
            },
            {
              "name": "Woodeforde’s Norfolk Nog"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Drier and more hop-oriented that southern English brown ale, with a nutty character rather than caramel.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Tröegs Rugged Trail Ale"
            },
            {
              "name": "Alesmith Nautical Nut Brown Ale"
            },
            {
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A fairly substantial English dark ale with restrained roasty characteristics.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Hambleton Nightmare Porter"
            },
            {
              "name": "Harvey’s Tom Paine Original Old Porter"
            },
            {
              "name": "Salopian Entire Butt English Porter"
            },
            {
              "name": "St. Peters Old-Style Porter"
            },
            {
              "name": "Shepherd Neame Original Porter"
            },
            {
              "name": "Flag Porter"
            },
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A substantial, malty dark ale with a complex and flavorful roasty character.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Avery New World Porter"
            },
            {
              "name": "Bell’s Porter"
            },
            {
              "name": "Great Divide Saint Bridget’s Porter"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A Baltic Porter often has the malt flavors reminiscent of an English brown porter and the restrained roast of a schwarzbier, but with a higher OG and alcohol content than either. Very complex, with multi-layered flavors.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Neuzeller Kloster-Bräu Neuzeller Porter",
              "note": "Germany"
            },
            {
              "name": "Southampton Imperial Baltic Porter"
            }
          ]
        }
      ]
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A very dark, roasty, bitter, creamy ale.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "O’Hara’s Celtic Stout"
            },
            {
              "name": "Russian River O.V.L. Stout"
            },
            {
              "name": "Three Floyd’s Black Sun Stout"
            },
            {
              "name": "Dorothy Goodbody’s Wholesome Stout"
            },
            {
              "name": "Orkney Dragonhead Stout"
            },
            {
              "name": "Old Dominion Stout"
            },
            {
              "name": "Goose Island Dublin Stout"
            },
            {
              "name": "Brooklyn Dry Stout"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A very dark, sweet, full-bodied, slightly roasty ale. Often tastes like sweetened espresso.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Watney's Cream Stout"
            },
            {
              "name": "Farson’s Lacto Stout"
            },
            {
            ...
            {
              "name": "Widmer Snowplow Milk Stout"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "mouthfeel": "Medium-full to full body, smooth, silky, sometimes an almost oily slickness from the oatmeal. Creamy. Medium to medium-hig carbonation.",
            "overallImpression": "A very dark, full-bodied, roasty, malty ale with a complementary oatmeal flavor.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "McAuslan Oatmeal Stout"
            },
            {
              "name": "Maclay’s Oat Malt Stout"
            },
            {
              "name": "Broughton Kinmount Willie Oatmeal Stout"
            },
            {
              "name": "Anderson Valley Barney Flats Oatmeal Stout"
            },
            {
              "name": "Tröegs Oatmeal Stout"
            },
            {
              "name": "New Holland The Poet"
            },
            {
              "name": "Goose Island Oatmeal Stout"
            },
            {
              "name": "Wolaver’s Oatmeal Stout"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A very dark, moderately strong, roasty ale. Tropical varieties can be quite sweet, while export versions can be drier and fairly robust.",
          ...
          "commercialExamples": [
            {
              "name": "Lion Stout",
              "note": "Tropical-Type; Sri Lanka"
            },
            {
              "name": "Dragon Stout",
              "note": "Tropical-Type; Jamaica"
            },
            {
              "name": "ABC Stout",
              "note": "Tropical-Type; Singapore"
            },
            {
              "name": "Royal Extra 'The Lion Stout'",
              "note": "Tropical-Type; Trinidad"
            },
            {
              "name": "Jamaica Stout",
              "note": "Tropical-Type; Jamaica"
            ...
            {
              "name": "Freeminer Deep Shaft Stout",
              "note": "Export-Type"
            },
            {
              "name": "Guinness Foreign Extra Stout",
              "note": "Export-Type; Bottled, not sold in the US"
            },
            {
              "name": "Ridgeway of Oxfordshire Foreign Extra Stout",
              "note": "Export-Type"
            },
            {
            ...
            {
              "name": "Elysian Dragonstooth Stout",
              "note": "Export-Type"
            }
          ]
        },
        {
          ...
          "commercialExamples": [
            ...
            {
              "name": "Bar Harbor Cadillac Mountain Stout"
            },
            {
            ...
            {
              "name": "Mad River Steelhead Extra Stout"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "An intensely flavored, big, dark ale. Roasty, fruity, and bittersweet, with a noticeable alcohol presence. Dark fruit flavors meld with roasty, burnt, or almost tar-like sensations. Like a black barleywine with every dimension of flavor coming into play.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Stone Imperial Stout"
            },
            {
              "name": "Samuel Smith Imperial Stout"
            },
            {
              "name": "Scotch Irish Tsarina Katarina Imperial Stout"
            },
            {
              "name": "Thirsty Dog Siberian Night"
            },
            {
            ...
            {
              "name": "Southampton Russian Imperial Stout"
            },
            {
              "name": "Rogue Imperial Stout"
            },
            {
              "name": "Bear Republic Big Bear Black Stout"
            },
            {
              "name": "Great Lakes Blackout Stout"
            },
            {
              "name": "Avery The Czar"
            },
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A hoppy, moderately strong pale ale that features characteristics consistent with the use of English malt, hops and yeast. Has less hop character and a more pronounced malt flavor than American versions.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Hampshire Pride of Romsey IPA"
            },
            {
              "name": "Burton Bridge Empire IPA"
            },
            {
              "name": "Middle Ages ImPailed Ale"
            },
            {
        ...
        },
        {
          ...
          "commercialExamples": [
            ...
            {
              "name": "Anderson Valley Hop Ottin’"
            },
            {
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "An intensely hoppy, very strong pale ale without the big maltiness and/or deeper malt flavors of an American barleywine. Strongly hopped, but clean, lacking harshness, and a tribute to historical IPAs. Drinkability is an important characteristic; this should not be a heavy, sipping beer. It should also not have much residual sweetness or a heavy character grain profile.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Three Floyd’s Dreadnaught"
            },
            {
              "name": "Avery Majaraja"
            },
            {
              "name": "Bell’s Hop Slam"
            },
            {
            ...
            {
              "name": "Moylan’s Hopsickle Imperial India Pale Ale"
            },
            {
              "name": "Stoudt’s Double IPA"
            },
            {
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A pale, spicy, fruity, refreshing wheat-based ale.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Schneider Weisse Weizenhell"
            },
            {
            ...
            {
              "name": "Plank Bavarian Hefeweizen"
            },
            {
              "name": "Ayinger Bräu Weisse"
            },
            {
              "name": "Ettaler Weissbier Hell"
            },
            {
            ...
            {
              "name": "Barrelhouse Hocking Hills HefeWeizen"
            },
            {
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A moderately dark, spicy, fruity, malty, refreshing wheat-based ale. Reflecting the best yeast and wheat character of a hefeweizen blended with the malty richness of a Munich dunkel.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Franziskaner Dunkel Hefe-Weisse"
            },
            {
            ...
            {
              "name": "Kapuziner Weissbier Schwarz"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A strong, malty, fruity, wheat-based ale combining the best flavors of a dunkelweizen and the rich strength and body of a bock.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Plank Bavarian Heller Weizenbock"
            },
            {
              "name": "AleSmith Weizenbock, Erdinger Pikantus"
            },
            {
              "name": "Mahr’s Der Weisse Bock"
            },
            {
              "name": "Victory Moonglow Weizenbock"
            },
            {
              "name": "High Point Ramstein Winter Wheat"
            },
            {
              "name": "Capital Weizen Doppelbock"
            },
            {
              "name": "Eisenbahn Vigorosa"
            }
          ]
        },
        {
          ...
          "commercialExamples": [
            {
              "name": "Paulaner Roggen",
              "note": "Formerly Thurn und Taxis, no longer imported into the US"
            },
            {
              "name": "Bürgerbräu Wolznacher Roggenbier"
            }
          ]
        }
      ]
      ...
      "subcategories": [
        {
          ...
          "commercialExamples": [
            ...
            {
              "name": "Brugs Tarwebier (Blanche de Bruges)"
            },
            {
              "name": "Wittekerke"
            },
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A fruity, moderately malty, somewhat spicy, easy-drinking, copper-colored ale.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "St. Pieters Zinnebir"
            },
            {
              "name": "Brewer’s Art House Pale Ale"
            },
            {
              "name": "Avery Karma"
            },
            ...
            },
            {
              ...
              "note": "Unusual in its 6.5% ABV strength"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A refreshing, medium to strong fruity/spicy ale with a distinctive yellow-orange color, highly carbonated, well hopped, and dry with a quenching acidity.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Fantôme Saison D’Erezée - Printemps"
            },
            {
            ...
            {
              "name": "Ellezelloise Saison 2000"
            },
            {
              "name": "Saison Silly"
            },
            {
              "name": "Southampton Saison"
            },
            {
              "name": "New Belgium Saison"
            },
            {
              "name": "Pizza Port SPF 45"
            },
            {
              "name": "Lost Abbey Red Barn Ale"
            },
            {
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A fairly strong, malt-accentuated, lagered artisanal farmhouse beer.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Jenlain Bière de Printemps",
              "note": "Blond"
            },
            {
              "name": "St. Amand",
            ...
            {
              "name": "La Choulette Bière des Sans Culottes",
              "note": "Blond"
            },
            {
              "name": "Saint Sylvestre 3 Monts",
              "note": "Blond"
            },
            {
              "name": "Biere Nouvelle",
            ...
            {
              "name": "Brasseurs Bière de Garde",
              "note": "Amber"
            },
            {
              "name": "Southampton Bière de Garde",
              "note": "Amber"
            },
            {
              "name": "Lost Abbey Avante Garde",
              "note": "Blond"
            }
          ]
        },
        {
          ...
          "commercialExamples": [
            ...
            {
              "name": "De Dolle’s Arabier"
            },
            {
              "name": "De Dolle’s Oerbier"
            },
            {
              "name": "De Dolle’s Boskeun"
            },
            {
              "name": "De Dolle’s Stille Nacht"
            },
            {
              "name": "La Chouffe"
            },
            ...
            {
              "name": "Ellezelloise Hercule Stout"
            },
            {
              "name": "Ellezelloise Quintine Amber"
            },
            {
            ...
            {
              "name": "Caracole Nostradamus"
            },
            {
              "name": "Silenrieu Sara"
            },
            {
              "name": "Silenrieu Joseph"
            },
            {
              "name": "Fantôme Black Ghost"
            },
            {
              "name": "Fantôme Speciale Noël"
            },
            {
              "name": "Dupont Moinette"
            },
            {
              "name": "Moinette Brune"
            },
            {
              "name": "Avec Les Bons Voeux de la Brasserie Dupont"
            },
            {
              "name": "St. Fullien Noël"
            },
            {
              "name": "Gouden Carolus Noël"
            },
            {
              "name": "Affligem Nöel"
            },
            {
              "name": "Guldenburg Noël"
            },
            {
              "name": "Pere Noël"
            },
            ...
            {
              "name": "New Belgium 1554 Black Ale"
            },
            {
              "name": "Cantillon Iris"
            },
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A very pale, sour, refreshing, low-alcohol wheat ale.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Weihenstephan 1809",
              "note": "Unusual in its 5% ABV"
            },
            {
              "name": "Bahnhof Berliner Style Weisse"
            },
            {
              "name": "Southampton Berliner Weisse"
            },
            {
              "name": "Bethlehem Berliner Weisse"
            },
            {
              "name": "Three Floyds Deesko"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A complex, sour, red wine-like Belgian-style ale.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Southampton Flanders Red Ale"
            },
            {
              "name": "Verhaege Vichtenaar"
            },
            {
              "name": "Monk’s Cafe Flanders Red Ale"
            },
            {
              "name": "New Glarus Enigma"
            },
            {
        ...
        },
        {
          ...
          "commercialExamples": [
            {
              "name": "Liefman’s Goudenband"
            },
            {
              "name": "Liefman’s Odnar"
            },
            {
              "name": "Liefman’s Oud Bruin"
            },
            {
              "name": "Ichtegem Old Brown"
            },
            {
              "name": "Riva Vondel"
            }
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Complex, sour/acidic, pale, wheat-based ale fermented by a variety of Belgian microbiota.",
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Complex, pleasantly sour/acidic, balanced, pale, wheat-based ale fermented by a variety of Belgian microbiota.",
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "mouthfeel": "Light to medium-light body. In spite of the low finishing gravity, the many mouth-filling flavors prevent the beer from tasting like water. Has a low to high tart, puckering quality without being sharply astringent. Some versions have a low warming character. Highly carbonated.",
            "overallImpression": "Complex, fruity, pleasantly sour/acidic, balanced, pale, wheat-based ale fermented by a variety of Belgian microbiota. A lambic with fruit, not just a fruit beer.",
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A moderate-strength golden ale that has a subtle Belgian complexity, slightly sweet flavor, and dry finish.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "La Trappe (Koningshoeven) Blond"
            },
            {
            ...
            {
              "name": "Straffe Hendrik Blonde"
            },
            {
              "name": "Brugse Zot"
            },
            {
              "name": "Pater Lieven Blond Abbey Ale"
            },
            {
              "name": "Troubadour Blond Ale"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A deep reddish, moderately strong, malty, complex Belgian ale.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "New Belgium Abbey Belgian Style Ale"
            },
            {
              "name": "Stoudts Abbey Double Ale"
            },
            {
              "name": "Russian River Benediction"
            },
            {
              "name": "Flying Fish Dubbel"
            },
            {
              "name": "Lost Abbey Lost and Found Abbey Ale"
            },
            {
              "name": "Allagash Double"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Strongly resembles a Strong Golden Ale but slightly darker and somewhat fuller-bodied. Usually has a more rounded malt flavor but should not be sweet.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Corsendonk Abbey Pale Ale"
            },
            {
            ...
            {
              "name": "Dragonmead Final Absolution"
            },
            {
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A golden, complex, effervescent, strong Belgian-style ale.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Great Divide Hades"
            },
            {
              "name": "Avery Salvation"
            },
            {
              "name": "North Coast Pranqster"
            },
            {
              "name": "Unibroue Eau Benite"
            },
            {
              "name": "AleSmith Horny Devil"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A dark, very rich, complex, very strong Belgian ale. Complex, rich, smooth and dangerous.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Brasserie des Rocs Grand Cru"
            },
            {
              "name": "Gulden Draak"
            },
            {
              "name": "Kasteelbier Bière du Chateau Donker"
            },
            {
              "name": "Lost Abbey Judgment Day"
            },
            {
              "name": "Russian River Salvation"
            }
          ]
        }
      ]
      ...
      "subcategories": [
        {
          ...
          "commercialExamples": [
            ...
            {
              "name": "Greene King Olde Suffolk Ale"
            },
            {
              "name": "J.W. Lees Moonraker"
            },
            {
            ...
            },
            {
              ...
              "note": "Peculiar at OG 1.057"
            },
            {
              "name": "Young's Winter Warmer"
            },
            {
              "name": "Sarah Hughes Dark Ruby Mild"
            },
            {
            ...
            {
              "name": "Great Divide Hibernation Ale"
            },
            {
              "name": "Founders Curmudgeon"
            },
            {
              "name": "Cooperstown Pride of Milford Special Ale"
            },
            {
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "The richest and strongest of the English Ales. A showcase of malty richness and complex, intense flavors. The character of these ales can change significantly over time; both young and old versions should be appreciated for what they are. The malt profile can vary widely; not all examples will have all possible flavors or aromas.",
          ...
          "commercialExamples": [
            ...
            },
            {
              ...
              "note": "Unusual in its 7.2% ABV"
            },
            {
              "name": "Whitbread Gold Label"
            },
            {
              "name": "Old Dominion Millenium"
            },
            {
              "name": "North Coast Old Stock Ale",
              "note": "When aged"
            },
            {
              "name": "Weyerbacher Blithering Idiot"
            }
          ]
        },
        {
          ...
          "commercialExamples": [
            ...
            {
              "name": "Three Floyds Behemoth"
            },
            {
              "name": "Stone Old Guardian"
            },
            {
              "name": "Bridgeport Old Knucklehead"
            },
            {
              "name": "Hair of the Dog Doggie Claws"
            },
            {
              "name": "Lagunitas Olde GnarleyWine"
            },
            {
              "name": "Smuttynose Barleywine"
            },
            {
              "name": "Flying Dog Horn Dog"
            }
          ]
        }
      ]
    },
    {
      ...
      "guidelines": {
        ...
        "overallImpression": "A harmonious marriage of fruit and beer. The key attributes of the underlying style will be different with the addition of fruit; do not expect the base beer to taste the same as the unadulterated version. Judge the beer based on the pleasantness and balance of the resulting combination.",
      ...
      "commercialExamples": [
        {
          "name": "New Glarus Belgian Red and Raspberry Tart"
        },
        {
        ...
        {
          "name": "Weyerbacher Raspberry Imperial Stout"
        },
        {
          "name": "Abita Purple Haze"
        },
        {
          "name": "Melbourne Apricot Beer and Strawberry Beer"
        },
        {
          "name": "Saxer Lemon Lager"
        },
        {
          "name": "Magic Hat #9"
        },
      ...
      "subcategories": [
        {
          ...
          "commercialExamples": [
            ...
            {
              "name": "Rogue Hazelnut Nectar"
            },
            {
              "name": "Hitachino Nest Real Ginger Ale"
            },
            {
              "name": "Breckenridge Vanilla Porter"
            },
            {
              "name": "Left Hand JuJu Ginger Beer"
            },
            {
            ...
            {
              "name": "Redhook Double Black Stout"
            },
            {
              "name": "Buffalo Bill's Pumpkin Ale"
            },
            {
              "name": "BluCreek Herbal Ale"
            },
            {
              "name": "Christian Moerlein Honey Almond"
            },
            {
              "name": "Rogue Chocolate Stout"
            },
            {
              "name": "Birrificio Baladin Nora"
            },
            {
        ...
        },
        {
          ...
          "commercialExamples": [
            ...
            {
              "name": "Nils Oscar Julöl"
            },
            {
              "name": "Goose Island Christmas Ale"
            },
            {
              "name": "North Coast Wintertime Ale"
            },
            {
            ...
            {
              "name": "Troegs The Mad Elf"
            },
            {
              "name": "Jamtlands Julöl"
            }
          ]
        }
      ]
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Märzen/Oktoberfest-style (see 3B) beer with a sweet, smoky aroma and flavor and a somewhat darker color.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Victory Scarlet Fire Rauchbier"
            },
            {
              "name": "Spezial Rauchbier Märzen"
            },
            {
              "name": "Saranac Rauchbier"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "This is any beer that is exhibiting smoke as a principle flavor and aroma characteristic other than the Bamberg-style Rauchbier (i.e., beechwood-smoked Märzen). Balance in the use of smoke, hops and malt character is exhibited by the better examples.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Schlenkerla Weizen Rauchbier"
            },
            {
              "name": "Schlenkerla Ur-Bock Rauchbier"
            },
            {
              "name": "Rogue Smoke"
            },
            ...
            {
              "name": "Left Hand Smoke Jumper"
            },
            {
              "name": "Dark Horse Fore Smoked Stout"
            },
            {
              "name": "Magic Hat Jinx"
            }
        ...
        },
        {
          ...
          "commercialExamples": [
            {
              "name": "The Lost Abbey Angel’s Share Ale"
            },
            {
              "name": "J.W. Lees Harvest Ale",
              "note": "In Port, Sherry, Lagavulin Whisky or Calvados Casks"
            },
            {
              "name": "Bush Prestige"
            },
            ...
            {
              "name": "Dominion Oak Barrel Stout"
            },
            {
              "name": "New Holland Dragons Milk"
            },
            {
            ...
            {
              "name": "Harviestoun Old Engine Oil Special Reserve"
            },
            {
              "note": "Many microbreweries have specialty beers served only on premises often directly from the cask."
            }
          ]
        }
      ]
    },
    {
      ...
      "commercialExamples": [
        {
          "name": "Bell’s Rye Stout"
        },
        {
          "name": "Bell’s Eccentric Ale"
        },
        {
        ...
        {
          "name": "Great Alba Scots Pine"
        },
        {
          "name": "Tommyknocker Maple Nut Brown Ale"
        },
        {
          "name": "Great Divide Bee Sting Honey Ale"
        },
        {
          "name": "Stoudt’s Honey Double Mai Bock"
        },
        {
          "name": "Rogue Dad’s Little Helper"
        },
        {
          "name": "Rogue Honey Cream Ale"
        },
        {
          "name": "Dogfish Head India Brown Ale"
        },
        {
          "name": "Zum Uerige Sticke"
        },
        {
          "name": "Doppel Sticke Altbier"
        },
        {
          "name": "Yards Brewing Company General Washington Tavern Porter"
        },
        {
          "name": "Rauchenfels Steinbier"
        },
        {
          "name": "Odells 90 Shilling Ale"
        },
        {
      ...
      "subcategories": [
        {
          ...
          "commercialExamples": [
            {
              "name": "White Winter Dry Mead"
            },
            {
              "name": "Sky River Dry Mead"
            },
            {
        ...
        },
        {
          ...
          "commercialExamples": [
            {
              "name": "Lurgashall English Mead"
            },
            {
              "name": "Redstone Traditional Mountain Honey Wine"
            },
            {
              "name": "Sky River Semi-Sweet Mead"
            },
            {
              "name": "Intermiel Verge d’Or"
            },
            {
              "name": "Intermiel Verge Mélilot"
            }
          ]
        },
        {
          ...
          "commercialExamples": [
            {
              "name": "Lurgashall Christmas Mead"
            },
            {
              "name": "Chaucer’s Mead"
            },
            {
              "name": "Rabbit’s Foot Sweet Wildflower Honey Mead"
            },
            {
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "In well-made examples of the style, the fruit is both distinctive and well-incorporated into the honey-sweet-acid-tannin-alcohol balance of the mead. Some of the best strong examples have the taste and aroma of an aged Calvados (apple brandy from northern France), while subtle, dry versions can taste similar to many fine white wines.",
          ...
          "commercialExamples": [
            {
              "name": "White Winter Cyser"
            },
            {
              "name": "Rabbit’s Foot Apple Cyser"
            },
            {
              "name": "Long Island Meadery Apple Cyser"
            }
          ]
        },
        {
          ...
          "commercialExamples": [
            {
              "name": "Redstone Pinot Noir Mountain Honey Wines"
            },
            {
              "name": "Redstone White Pyment Mountain Honey Wines"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "In well-made examples of the style, the fruit is both distinctive and well-incorporated into the honey-sweet-acid-tannin-alcohol balance of the mead. Different types of fruit can result in widely different characteristics; allow for a variation in the final product.",
          ...
          "commercialExamples": [
            {
              "name": "White Winter Blueberry, Raspberry and Strawberry Melomels"
            },
            {
              "name": "Redstone Black Raspberry and Sunshine Nectars"
            },
            {
              "name": "Bees Brothers Raspberry Mead"
            },
            {
              "name": "Bees Brothers Intermiel Honey Wine and Raspberries"
            },
            {
              "name": "Bees Brothers Honey Wine and Blueberries"
            },
            {
              "name": "Bees Brothers Honey Wine and Blackcurrants"
            },
            {
              "name": "Long Island Meadery Blueberry Mead"
            },
            {
              "name": "Mountain Meadows Cranberry Mead"
            },
            {
              "name": "Mountain Meadows Cherry Mead"
            }
          ]
        }
      ]
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "In well-made examples of the style, the herbs/spices are both distinctive and well-incorporated into the honey-sweet-acid-tannin-alcohol balance of the mead. Different types of herbs/spices can result in widely different characteristics; allow for a variation in the final product.",
          ...
          "commercialExamples": [
            {
              "name": "Bonair Chili Mead"
            },
            {
              "name": "Redstone Juniper Mountain Honey Wine"
            },
            {
              "name": "Redstone Vanilla Beans and Cinnamon Sticks Mountain Honey Wine"
            },
            {
              "name": "Long Island Meadery Vanilla Mead"
            },
            {
              "name": "iQhilika Africa Birds Eye Chilli Mead"
            },
            {
              "name": "Mountain Meadows Spice Nectar"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "A harmonious blend of mead and beer, with the distinctive characteristics of both. A wide range of results are possible, depending on the base style of beer, variety of honey and overall sweetness and strength. Beer flavors tend to somewhat mask typical honey flavors found in other meads.",
          ...
          "commercialExamples": [
            {
              "name": "Rabbit’s Foot Diabhal"
            },
            {
              "name": "Rabbit’s Foot Bière de Miele"
            },
            {
              "name": "Magic Hat Braggot"
            },
            {
              "name": "Brother Adams Braggot Barleywine Ale"
            },
            {
              "name": "White Winter Traditional Brackett"
            }
          ]
        },
        {
          ...
          "letter": "C",
          "guidelines": {
            "aroma": "Generally follows the standard descriptions, yet note that all the characteristics may vary. Since a wide range of entries are possible, note that the characteristics may reflect combinations of the respective elements of the various sub-categories used in this style. Refer to Category 25 for a detailed description of the character of dry, semisweet and sweet mead. If the entered mead is a combination of other existing mead categories, refer to the constituent categories for a detailed description of the character of the component styles.",
            "appearance": "Generally follows the standard descriptions, yet note that all the characteristics may vary. Since a wide range of entries are possible, note that the characteristics may reflect combinations of the respective elements of the various sub-categories used in this style. Refer to Category 25 for a detailed description of the character of dry, semisweet and sweet mead. If the entered mead is a combination of other existing mead categories, refer to the constituent categories for a detailed description of the character of the component styles.",
            "flavor": "Generally follows the standard descriptions, yet note that all the characteristics may vary. Since a wide range of entries are possible, note that the characteristics may reflect combinations of the respective elements of the various sub-categories used in this style. Refer to Category 25 for a detailed description of the character of dry, semisweet and sweet mead. If the entered mead is a combination of other existing mead categories, refer to the constituent categories for a detailed description of the character of the component styles.",
            "mouthfeel": "Generally follows the standard descriptions, yet note that all the characteristics may vary. Since a wide range of entries are possible, note that the characteristics may reflect combinations of the respective elements of the various sub-categories used in this style. Refer to Category 25 for a detailed description of the character of dry, semisweet and sweet mead. If the entered mead is a combination of other existing mead categories, refer to the constituent categories for a detailed description of the character of the component styles.",
            "overallImpression": "This mead should exhibit the character of all of the ingredients in varying degrees, and should show a good blending or balance between the various flavor elements. Whatever ingredients are included, the result should be identifiable as a honey-based fermented beverage.",
          ...
          "commercialExamples": [
            ...
            {
              "name": "Hanssens/Lurgashall Mead the Gueuze"
            },
            {
              "name": "Rabbit’s Foot Private Reserve Pear Mead"
            },
            {
              "name": "White Winter Cherry Bracket"
            },
            {
              "name": "Saba Tej"
            },
            {
              "name": "Mountain Meadows Trickster’s Treat Agave Mead"
            },
            {
              "name": "Intermiel Rosée"
            }
          ]
        }
      ]
      ...
      "subcategories": [
        {
          ...
          "letter": "A",
          "guidelines": {
            "aroma": "Sweet or low-alcohol ciders may have apple aroma. Dry ciders will be more wine-like with some esters. Sugar and acidity should combine to give a refreshing character, neither cloying nor too austere. Medium to high acidity.",
            "flavor": "Sweet or low-alcohol ciders may have apple flavor. Dry ciders will be more wine-like with some esters. Sugar and acidity should combine to give a refreshing character, neither cloying nor too austere. Medium to high acidity.",
            ...
            "overallImpression": "Variable, but should be a medium, refreshing drink. Sweet ciders must not be cloying. Dry ciders must not be too austere. An ideal cider serves well as a 'session' drink, and suitably accompanies a wide variety of food.",
          ...
          "commercialExamples": [
            {
              "name": "Red Barn Cider Jonagold Semi-Dry",
              "note": "WA, US"
            },
            {
              "name": "Red Barn Cider Jonagold Sweetie Pie",
              "note": "WA, US"
            },
            {
              "name": "AEppelTreow Barn Swallow Draft Cider",
              "note": "WI, US"
            },
            {
              "name": "Wandering Aengus Heirloom Blend Cider",
              "note": "OR, US"
            },
            {
              "name": "Uncle John’s Fruit House Winery Apple Hard Cider",
              "note": "MI, US"
            },
            {
              "name": "Bellwether Spyglass",
              "note": "NY, US"
            },
            {
              "name": "West County Pippin",
              "note": "MA, US"
            },
            {
              "name": "White Winter Hard Apple Cider",
              "note": "WI, US"
            },
            {
              "name": "Harpoon Cider",
        ...
        },
        {
          ...
          "letter": "B",
          "guidelines": {
            "aroma": "May have 'smoky (bacon)' character from a combination of apple varieties and MLF. Some 'Farmyard nose' may be present but must not dominate; mousiness is a serious fault. The common slight farmyard nose of an English West Country cider is the result of lactic acid bacteria, not a Brettanomyces contamination.",
            "flavor": "No overt apple character, but various flavors and esters that suggest apples. May have 'smoky (bacon)' character from a combination of apple varieties and MLF.",
            ...
            "overallImpression": "Generally dry, full-bodied, austere.",
          ...
          "commercialExamples": [
            {
              "name": "Westcott Bay Traditional Very Dry",
              "note": "WA, US"
            },
            {
              "name": "Westcott Bay Traditional Dry",
              "note": "WA, US"
            },
            {
              "name": "Westcott Bay Traditional Medium Sweet",
              "note": "WA, US"
            },
            {
              "name": "Farnum Hill Extra-Dry",
              "note": "NH, US"
            },
            {
              "name": "Farnum Hill Dry",
              "note": "NH, US"
            },
            {
              "name": "Farnum Hill Farmhouse",
              "note": "NH, US"
            },
            {
              "name": "Wandering Aengus Dry Cider",
              "note": "OR, US"
            },
            {
              "name": "Red Barn Cider Burro Loco",
              "note": "WA, US"
            },
            {
              "name": "Bellwether Heritage",
              "note": "NY, US"
            },
            {
              "name": "Oliver’s Herefordshire Dry Cider",
              "note": "UK"
            },
            {
              "name": "Hecks Dry Cider",
              "note": "UK; Various"
            },
            {
              "name": "Dunkerton Dry Cider",
              "note": "UK; Various"
            },
            {
            ...
            {
              "name": "Gwatkin Yarlington Mill Dry Cider",
              "note": "UK; Various"
            },
            {
        ...
        },
        {
          ...
          "commercialExamples": [
            {
              "name": "West County Reine de Pomme",
              "note": "MA, US"
            },
            {
              "name": "Rhyne Cider",
        ...
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Mild. Medium to medium-sweet. Still to lightly sparkling. Only very slight acetification is acceptable. Mousiness, ropy/oily characters are serious faults.",
          ...
          "commercialExamples": [
            {
              "name": "White Winter Hard Pear Cider",
              "note": "WI, US"
            },
            {
              "name": "AEppelTreow Perry",
              "note": "WI, US"
            },
            {
              "name": "Blossomwood Laughing Pig Perry",
              "note": "CO, US"
            },
            {
              "name": "Uncle John’s Fruit House Winery Perry",
              "note": "MI, US"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Tannic. Medium to medium-sweet. Still to lightly sparkling. Only very slight acetification is acceptable. Mousiness, ropy/oily characters are serious faults.",
          ...
          "commercialExamples": [
            {
              "name": "Bordelet Poire Authentique",
              "note": "France"
            },
            {
              "name": "Bordelet Poire Granit",
              "note": "France"
            },
            {
            ...
            {
              "name": "Gwatkin Blakeney Red Perry",
              "note": "UK"
            },
            {
              "name": "Oliver’s Blakeney Red Perry",
              "note": "UK"
            },
            {
              "name": "Oliver’s Herefordshire Dry Perry",
              "note": "UK"
            }
          ]
        }
      ...
      "subcategories": [
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Substantial body and character.",
          ...
          "commercialExamples": [
            {
              "note": "There are no known commercial examples of New England Cider."
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Like a dry wine with complex flavors. The apple character must marry with the added fruit so that neither dominates the other.",
          ...
          "commercialExamples": [
            {
              "name": "West County Blueberry-Apple Wine",
              "note": "MA, US"
            },
            {
              "name": "AEppelTreow Red Poll Cran-Apple Draft Cider",
              "note": "WI, US"
            },
            {
              "name": "Bellwether Cherry Street",
              "note": "NY, US"
            },
            {
              "name": "Uncle John’s Fruit Farm Winery Apple Cherry Hard Cider",
              "note": "MI, US"
            }
          ]
        },
        {
          ...
          "guidelines": {
            ...
            "overallImpression": "Like a dry white wine, balanced, and with low astringency and bitterness.",
          ...
          "commercialExamples": [
            {
              "name": "AEppelTreow Summer’s End",
              "note": "WI, US"
            },
            {
              "name": "Wandering Aengus Pommeau",
              "note": "OR, US"
            },
            {
              "name": "Uncle John’s Fruit House Winery Fruit House Apple",
              "note": "MI, US"
            },
            {
              "name": "Irvine's Vintage Ciders",
              "note": "WA, US"
            }
          ]
        },
        {
          ...
          "commercialExamples": [
            {
              "name": "Red Barn Cider Fire Barrel",
              "note": "WA, US"
            },
            {
              "name": "AEppelTreow Pear Wine and Sparrow Spiced Cider",
              "note": "WI, US"
            }
          ]
        }
...
beerStyles = [];
for( var i = 0, beer_len = beers.beers.length; i < beer_len; i++){
  category = beers.beers[i].subcategories;
  if(typeof(category) !== 'undefined'){
    for( var j = 0, cat_len = category.length; j < cat_len; j++){
      beerStyles.push(category[j].name);
    }
  }
}
